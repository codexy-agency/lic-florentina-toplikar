...
// Fail-closed en producción: si configuraron la URL pero falta la service_role o
// el professional_id, NO degradamos en silencio al archivo local (efímero en
// serverless → "se guardó" pero se pierde al reciclar la lambda). Mejor romper
// fuerte y visible para que se corrija la variable que falta.
