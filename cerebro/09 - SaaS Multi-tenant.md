...
- **PENDIENTE — Default de password hardcodeado.** `lib/auth.ts` L5-6 cae a `"paulina2026"` y a un secreto `"cambia-este-secreto-en-produccion"` si faltan las env vars. Aceptable para la demo, inadmisible en producción multi-cliente.
